            ...
            <div class="page-content fade-in-up" id="dashboard-content">
                        ...
                        <tbody>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    {{-- <td><span class="status-badge status-{{$user->status =="validated" ? "active" : $user->status =="pending" ? "pending" : "inactive"}}">{{ $user->status }}</span></td> --}}
                                    <td>
                                        <!-- Valider le user -->
                                        <a href="#" class="action-validate" title="Valider"
                                            id="validateusere{{ $user->id }}">
                                            <i class="fas fa-check-circle"></i>
                                        </a>
                                        <!-- Rejeter le user -->
                                        <a href="#" class="action-reject" title="Rejeter"
                                            id="Rejectusere{{ $user->id }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="userModalLabel">Détail du
                                                    user {{ $user->nom }}</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="card" style="width: 100%;">
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item">{{ $user->nom }}
                                                            {{ $user->prenom }}</li>
                                                        <li class="list-group-item">{{ $user->email }} /
                                                            {{ $user->telephone }}</li>
                                                        <li class="list-group-item">{{ $user->entite }} /
                                                            {{ $user->nom_entite }}</li>
                                                        <li class="list-group-item">{{ $user->pays }} /
                ...
                <div class="table-footer"
                    ...
                    <div class="page-controls" style="display:flex; align-items:center; gap:12px;">
                        <label for="rowsPerPage" style="font-size:0.9rem; color:var(--text-secondary);">Afficher</label>
                    ...
                    <nav class="pagination-container" id="client-pagination" aria-label="Pagination"
                        style="display: flex">
